...
use App\Http\Controllers\Api\Front\DesignController;
...
Route::group(['prefix' => 'v1'], function () {
    ...
    //product list
    Route::get('products', 'Api\Front\SearchController@searchProducts');
    Route::get('font-families', 'Api\Front\FrontendController@getFontFamilies');
    Route::get('ttf-fonts', 'Api\Front\FrontendController@getTtfFonts');

    Route::resource('design', \Api\Front\DesignController::class)
        ->except(['destroy']);
    Route::get('design/destroy/{id}', [DesignController::class, 'destroy'])
        ->name('design.destroy');


    Route::post('webhook', 'Api\Front\FrontendController@handleWebhook');
    Route::get('active-webhook', 'Api\Front\FrontendController@activeWebhookEvent');
    Route::post('update/trackwebhook', [OrderController::class , 'trackwebhook'])->name('trackwebhook');

    Route::get('get-variant-details', 'Api\Front\FrontendController@getVariantDetails');

    Route::get('get-temp-page-details/{id}', 'Api\Front\FrontendController@getTempPageDetails');
    Route::post('store-temp-page-details', 'Api\Front\FrontendController@storeTempPageDetails');
        
    Route::post('price-calculate', 'Api\Front\FrontendController@priceCalculate');

    Route::post('add-to-cart', 'Api\Front\FrontendController@addToCart');
    Route::post('parseExcel', 'Api\Front\FrontendController@parseExcel');
    Route::get('getCart/{id}', 'Api\Front\FrontendController@getCart');
});
