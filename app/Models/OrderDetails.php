...
class OrderDetails extends Model
{
    ...
    {
        return $this->hasMany(OrderDetailsDesc::class, 'desc_id', 'id');
    }

    public function getFrontDesignUrlAttribute()
    {
        if ($this->product_front_design) {
            return asset('storage/ModifiedProduct/front/' .$this->product_front_design);
        }else {
            return null;
        }
    }
    ...
    public function getBackDesignUrlAttribute() {
        ...
        if ($this->product_back_design) {
            return asset('assets/ModifiedProduct/back/' .$this->product_back_design);
        }else {
            return null;
        }
