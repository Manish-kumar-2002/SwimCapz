<script>
    ...
    $("#tsize-section").append(
                                '<div class="tsize-area dipc mb-4">'+
                                   
                                    '<input  type="text" class="input-field tsize" name="size_all[]" placeholder="{{ __("Enter Product Size") }}"  required="">'+ '<span class="remove tsize-remove ml-4"><i class="fas fa-trash-alt"></i></span>'+
                                '</div>'
                            );
    ...
    $(document).on('click','.color-add-more', function() {
        let html=`<tr>
