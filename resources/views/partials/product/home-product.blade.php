          ...
          <!-- <div class="hover-area">
            ...
            @if ($prod->type != "Listing")
               ...
               <div class="cart-button buynow">
                  <a  class="button add_to_cart_button add-to-cart-quick" href="javascript:;"  data-href="{{ route('product.cart.quickadd',$prod->id) }}" data-bs-placement="right" title="{{ __('Buy Now') }}" data-bs-original-title="{{ __('Buy Now') }}"></a>
               </div>
            @endif
            @endif
            @endif
