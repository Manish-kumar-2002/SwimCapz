                            ...
                            <figure class="woocommerce-product-gallery__wrapper">
                                <div class="product_view">
                                    <img id="single-image-zoom"
                                        src="{{ filter_var($variant_details->variantImages[0]->images, FILTER_VALIDATE_URL)
            ...
            <div class="col-12 col-lg-5 col-md-8">
                <div class="summary entry-summary right-block">
                    <div class="summary-inner">
                        ...
                        <p><strong>{{ Helper::convertPrice($variant_details->price) }}</strong> / each</p>
                            ...
                            @if (count($productt->variant) > 1)
                                ...
                                <ul class="color-list">
                                    @foreach ($productt->variant as $variant_color)
                                        <?php
                                        $style = $variant_color->id == $variant_details->id ? 'style="border: 3px solid #e02020;padding: 3px;"' : '';
                                        ?>
                        ...
                        <ul class="product-info-listing">
                            ...
                            <li>
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                    ...
                                    <g clip-path="url(#clip0_515_2237)">
                                        <path d="M7.3335 2.75H21.0835V14.6667H7.3335V2.75Z" stroke="#5C5C5C"
                            ...
                            @if ($productt->sku != null)
                                <li
                                    ...
                                    <span class="h6">{{ __('Product SKU:') }} </span> {{ $productt->sku }}
                                </li>
                            @endif
                        ...
                        <div class="btn-wrap">
                            <a href="{{ route('tool.details') }}?product-id={{ $variant_details->id }}"
                                class="btn red">Design now</a>
                        </div>
