              ...
              <div class="login-form">
                ...
                <form id="passwordform" action="{{ route('admin.change.password') }}" method="POST">
                  ...
                  <div class="form-input">
                    <input type="password" name="newpass" class="Password" placeholder="{{ __('New Password') }}" required=""><i class="fa fa-eye" aria-hidden="true" onclick="togglePasswordVisibility('newpass')"></i>
                  </div>

                  <div class="form-input">
                    <input type="password" name="renewpass" class="Password" placeholder="{{ __('Confirm New Password') }}" required=""><i class="fa fa-eye" aria-hidden="true" onclick="togglePasswordVisibility('renewpass')"></i>
                  </div>
