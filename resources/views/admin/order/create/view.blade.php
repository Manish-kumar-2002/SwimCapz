                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th width="10%">:</th>
                                        <td width="45%">
                                            {{ $address['customer_country'] ? $address['customer_country'] : '--' }}</td>
                                    </tr>
                                    @if (@$address['customer_city'] != null)
                                        <tr>
                                            ...
                                            <th width="10%">:</th>
                                            <td width="45%">
                                                {{ $address['customer_state'] ? $address['customer_state'] : '--' }}</td>
                                        </tr>
                                    @endif
                                    <tr>
                                        ...
                                        <th width="10%">:</th>
                                        <td width="45%">
                                            {{ $address['customer_city'] ? $address['customer_city'] : '--' }}</td>
                                    </tr>
                                    <tr>
                                        <th width="45%">{{ __('Postal Code') }}</th>
                                        <th width="10%">:</th>
                                        <td width="45%">{{ $address['customer_zip'] ? $address['customer_zip'] : '--' }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="table-responsive-sm">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('admin-order-create-submit') }}" class="mybtn1">Order
                                                Submit</a>
                                        </td>
                                    </tr>
                                </tbody>
