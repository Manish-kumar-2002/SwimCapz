...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __(Helper::getStatusLabelByStatus($status)) }}</h4>
                    <ul class="links">
                        <li>
                        ...
                        <li>
                            {{ __(Helper::getStatusLabelByStatus($status)) }}
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <script type="text/javascript">
        (function($) {
            ...
            var table = $('#geniustable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route("admin-order-datatables", $status) }}',
                ...
                columns: [
                    ...
                    @if ($status == null)
                        {
                            data: 'order_custom_status',
                            name: 'order_custom_status'
                        },
                        {
                            data: 'payment_custom_status',
                            name: 'payment_custom_status'
                        },
                    @endif
            ...
            $(function() {
                let url="{{ route('order.download', $status) }}";
                $(".btn-area").append('<div class="table-contents">' +
                    '<a class="add-btn" href="'+url+'">' +
