...
@section('content')
    <input type="hidden" id="headerdata" value="{{ __('Reported Problem') }}">
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Reported Problem') }}</h4>
                    <ul class="links">
                        <li>
    ...
    <script type="text/javascript">
        (function($) {
            ...
            var table = $('#geniustable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('reported-problems.index') }}",
