                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusformdata" action="{{ route('admin-currency-store') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="name"
                                            placeholder="{{ __('Enter Currency Code') }}" required="" value="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="sign"
                                            placeholder="{{ __('Enter Currency Sign') }}" required="" value="">
                                    </div>
                                </div>
								...
								<div class="row">
                                    ...
                                    <div class="col-lg-7 choose-file-input">
                                        <input type="file" class="input-field" name="icon"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <button class="addProductSubmit-btn"
                                            type="submit">{{ __('Create Currency') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
