            ...
            <div class="login-area">x
              ...
              <div class="login-form">
                ...
                <form id="loginform" action="{{ route('admin.login.submit') }}" method="POST">
                  ...
                  <div class="form-input">
                  <input type="password" name="password" class="Password" placeholder="{{ __('Type Password') }}" id="password-input">
                  <i class="fa fa-eye-slash" id="toggle-password" style="top:43% !important"></i>
                  </div>
