                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form
								id="geniusformdata"
								action="{{ route('admin-sociallink-update', $data->id) }}"
								method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="link"
                                            placeholder="{{ __('Location') }}" required="" value="{{ $data->link }}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 d-flex">
                                        ...
                                        <input type="text" id="icons" class="input-field" name="icon"
                                            placeholder="{{ __('Social Icon') }}" required=""
                                            value="{{ $data->icon }}">
