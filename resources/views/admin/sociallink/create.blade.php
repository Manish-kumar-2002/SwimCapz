...
@section('content')
    <div class="content-area">
        ...
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Add New Link') }} <a class="add-btn"
                            href="{{ route('admin-sociallink-index') }}"><i class="fas fa-arrow-left"></i>
                            {{ __('Back') }}</a></h4>
                    <ul class="links">
                        <li>
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusformdata" action="{{ route('admin-sociallink-create') }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Social Link') }}
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="link"
                                            placeholder="{{ __('Social Link') }}" required="" value="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 d-flex">
                                        <i class="" id="icn"></i>
                                        <input type="text" id="icons" class="input-field" name="icon"
                                            placeholder="{{ __('Social Icon') }}" required="" value="">
