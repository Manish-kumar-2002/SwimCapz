...
@section('content')
    <div class="content-area">
        ...
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Edit Coupon') }}
						<a
							class="add-btn"
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="coupon" action="{{ route('admin-coupon-update', $data->id) }}" method="POST"
                                enctype="multipart/form-data">
                                {{ csrf_field() }}

                                @include('admin.coupon.common', ['coupon' => $data])
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
...
@section('scripts')
    ...
    @include('admin.coupon.commonJs', ['coupon' => $data])
@endsection
