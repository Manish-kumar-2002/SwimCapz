                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks {{ $gs->is_smtp == 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('admin-gs-status',['is_smtp',1])}}" {{ $gs->is_smtp == 1 ? 'selected' : '' }}>{{ __('Active') }}</option>
                                      <option data-val="0" value="{{route('admin-gs-status',['is_smtp',0])}}" {{ $gs->is_smtp == 0 ? 'selected' : '' }}>{{ __('Inactive') }}</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
