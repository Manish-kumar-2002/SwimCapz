...
@section('content')
            ...
            <div class="content-area">
              ...
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('Add New Gallery') }} <a class="add-btn" href="{{route('admin-gallery-index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{ route('admin-gallery-create') }}">{{ __('Add Gallery') }}</a>
                        </li>
                      </ul>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-gallery-home-store')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              <div class="img-upload">
                                <div id="image-preview1" class="img-preview" style="background: url({{asset('assets/images/noimage.png') }});">
                                  <label for="image-upload1" class="img-label" id="image-label1"><i class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
                                  <input type="file" name="logo" class="img-upload" id="image-upload1">
                                </div>
                              </div>
                            </div>
                         </div>
