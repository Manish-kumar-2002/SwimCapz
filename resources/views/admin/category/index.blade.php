...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('All Category') }}</h4>
                    <ul class="links">
                        <li>
                            <a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }} </a>
                        </li>
                        <li><a href="javascript:;">{{ __('Category Management') }}</a></li>
                        <li>
                            ...
                            <table id="geniustable"
                                ...
                                <thead>
                                    <tr>
                                        <th scope>{{ __('Name') }}</th>
                                        <th scope>{{ __('Slug') }}</th>
                                        <th scope>{{ __('Featured') }}</th>
                                        <th scope>{{ __('Status') }}</th>
    ...
    <div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="text-center">
                        {{ __('You are about to delete this Category.
                            Everything under this category will be deleted') }}.
                    </p>
                ...
                $(".btn-area").append(`
                    <div class="table-contents">
                        <a
                            ...
                            data-href="{{ route('admin-cat-create') }}"
                            id="add-data"
                            data-toggle="modal"
                            data-target="#modal1"
                        >
                            <i class="fas fa-plus"></i>
                            <span class="remove-mobile">{{ __('Add New') }}</span>
                        </a>&nbsp;
                        <a
                            class="add-btn"
                            href="{{ route('category.download') }}"
                        >
