                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks {{ $gs->is_affilate == 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('admin-gs-status',['is_affilate',1])}}" {{ $gs->is_affilate == 1 ? 'selected' : '' }}>{{ __('Active') }}</option>
                                      <option data-val="0" value="{{route('admin-gs-status',['is_affilate',0])}}" {{ $gs->is_affilate == 0 ? 'selected' : '' }}>{{ __('Inactive') }}</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
                                ...
                                <div class="action-list">
                                    <select
                                        ...
                                        <option data-val="1" value="{{route('admin-gs-status',['product_affilate',1])}}"
                                            {{ $gs->product_affilate == 1 ? 'selected' : '' }}>{{ __('Active') }}
                                        </option>
                                        <option data-val="0" value="{{route('admin-gs-status',['product_affilate',0])}}"
                                            {{ $gs->product_affilate == 0 ? 'selected' : '' }}>{{ __('Inactive') }}
                                        </option>
                                    </select>
                                </div>
                            </div>
