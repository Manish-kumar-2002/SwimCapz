            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="javascript:;">{{ __('Product Management') }} </a>
                        </li>
                        <li>
                            <a href="{{ route('admin-prod-index') }}">{{ __('Manage Product') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            $(function() {
				...
				$(".btn-area").append(`
                    <div class="table-contents">
                        ...
                        <a
                            class="add-btn"
                            href="{{ route('admin-prod-download') }}"
                        >
