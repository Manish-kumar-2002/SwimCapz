                        ...
                        <div class="body-area">
                            ...
                            <form action="{{ route('admin-gs-prod-settings-update') }}" id="geniusformdata" method="POST"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1"
                                                    value="{{ route('admin-gs-status', ['is_contact_seller', 1]) }}"
                                                    {{ $gs->is_contact_seller == 1 ? 'selected' : '' }}>
                                                    {{ __('Activated') }}
                                                </option>
                                                <option data-val="0"
                                                    value="{{ route('admin-gs-status', ['is_contact_seller', 0]) }}"
                                                    {{ $gs->is_contact_seller == 0 ? 'selected' : '' }}>
                                                    {{ __('Deactivated') }}
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="number" class="input-field"
                                            placeholder="{{ __('Display Products Per Page') }}"
                                            name="seller_product_count" value="{{ $gs->seller_product_count }}"
                                            required="" min="0">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1"
                                                    value="{{ route('admin-gs-status', ['physical', 1]) }}"
                                                    {{ $gs->physical == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                </option>
                                                <option data-val="0"
                                                    value="{{ route('admin-gs-status', ['physical', 0]) }}"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1"
                                                    value="{{ route('admin-gs-status', ['digital', 1]) }}"
                                                    {{ $gs->digital == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                </option>
                                                <option data-val="0"
                                                    value="{{ route('admin-gs-status', ['digital', 0]) }}"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1"
                                                    value="{{ route('admin-gs-status', ['license', 1]) }}"
                                                    {{ $gs->license == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                </option>
                                                <option data-val="0"
                                                    value="{{ route('admin-gs-status', ['license', 0]) }}"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1"
                                                    value="{{ route('admin-gs-status', ['listing', 1]) }}"
                                                    {{ $gs->listing == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                </option>
                                                <option data-val="0"
                                                    value="{{ route('admin-gs-status', ['listing', 0]) }}"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1"
                                                    value="{{ route('admin-gs-status', ['affilite', 1]) }}"
                                                    {{ $gs->affilite == 1 ? 'selected' : '' }}>{{ __('Activated') }}
                                                </option>
                                                <option data-val="0"
                                                    value="{{ route('admin-gs-status', ['affilite', 0]) }}"
