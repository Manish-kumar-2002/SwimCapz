               ...
               <div id="sidebar" class="sidebar-blog bg-light p-30">
                  ...
                  <div class="widget border-0 py-0 widget_categories">
                     ...
                     <ul>
                        ...
                        <li><a class="{{ isset($bcat) ? ($bcat->id == $cat->id ? 'active' : '') : '' }}" href="{{ route('front.blogcategory',$cat->slug) }}">{{ $cat->name }}  ({{ $cat->blogs_count }}) </a></li>
                        @endforeach
                     </ul>
                  </div>
                  <div class="widget border-0 py-0 widget_recent_entries">
                     ...
                     <ul>
                        @foreach (App\Models\Blog::latest()->limit(4)->get() as $blog)
                        <li>
                  ...
                  <div class="col-md-12">
                     <div class="thumb-blog-horizontal clearfix hover-img-zoom transation mb-30">
                        ...
                        <div class="post-content ps-3">
                           ...
                           <div class="date font-small text-uppercase"><span>{{ date('M d - Y',(strtotime($blog->created_at))) }}</span></div>
                        </div>
                     </div>
                  </div>
               </div>
