            ...
            if (text_val.indexOf('\n') >= 0) {
                ...
                if (activeObj['name'] === 'singleLineText') {
                    ...
                    var txt = new fabric.Text(text_val, {
                        ...
                        'scaleX': previousSelectedObjecfont-size-selectt['scaleX'],
                        'scaleY': previousSelectedObject['scaleY'],
                        'originX': 'center',
                        'originY': 'center',
                        'name': 'mutliLineText',
                        'stroke': strokeColor ? strokeColor : '#f5f5f5',
                        'strokeWidth': ShowOutline ? ShowOutline : 0,
...
const makeEffect = () => {
    ...
    if (currentGroup && currentGroup['name'] === 'singleLineText') {
        ...
        if (selectEffect === 'Bulge') {
            bulgeEffect(val);
        } else if (selectEffect === 'Curve') {
            archEffect(val);
        } else if (selectEffect === 'Arch') {
            curveEffect(val);
        } else if (selectEffect === 'Wedge') {
            wedgeEffect(val);
        } else if (selectEffect === 'Diagonal') {
            diagonalEffect(val);
        } else if (selectEffect === 'Wave') {
            effectsEffect(val);
        } else if (selectEffect === 'Effect') {
            waveEffect(val);
        } else if (selectEffect === 'Upper') {
            upperEffect(val);
        } else if (selectEffect === 'Roof') {
            roofEffect(val);
        } else if (selectEffect === 'Bridge') {
            roofEffect(val, 'data');
        } else if (selectEffect === 'Hwedge') {
            hWedgeEffect(val);
        } else if (selectEffect === 'Slope') {
            skewXEffect(val, 'skewXEffect');
        } else if (selectEffect === 'IText') {
            skewXEffect(val, 'skewYEffect');
        } else if (selectEffect === 'SlopeIText') {
            skewXEffect(val, 'skewXYEffect');
        } else if (selectEffect === 'Test') {
            skewXEffect(val, 'testEffect');
        } else if (selectEffect === 'straight') {
